        ...
        <div className="min-h-screen bg-brand-background font-sans text-brand-text-primary animate-fade-in-up">
            ...
            <main className="px-6 lg:px-12">
                ...
                <section className="text-center py-20 lg:py-32">
                    ...
                    <button 
                        onClick={onLaunchApp}
                        className="mt-10 bg-brand-primary text-white font-bold py-4 px-8 rounded-full text-lg hover:bg-green-500 transform hover:scale-105 transition-transform duration-300"
                    >
